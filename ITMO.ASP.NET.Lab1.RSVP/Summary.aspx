<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="Summary.aspx.cs" Inherits="ITMO.ASP.NET.Lab1.RSVP.Summary" %>
<%@ Import Namespace="ITMO.ASP.NET.Lab1.RSVP" %>
<asp:Content ID="SumContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h2>Приглашения</h2>
